#Use this for zcPLC console: http://eyalarubas.com/python-subproc-nonblock.html
import subprocess
import socket
import errno
import time
...
class runtime:
    ...
    def start_runtime(self):
        if (self.status() == "Stopped"):
            # Updated to use zcplc binary name
            self.theprocess = subprocess.Popen(['./core/zcplc'])
